...
\begin{figure*}[t]
\centering
\includegraphics[width=0.65\textwidth]{pipeline_diagram.png}
\caption{The multimodal weak supervision pipeline. We aggregate LLM text classifications and VLM multimodal scores to generate a probabilistic exploitation score, which is then validated against human annotations and used for engagement premium analysis.}
\label{fig:pipeline}
\end{figure*}
